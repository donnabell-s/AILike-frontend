        ...
        <div className="w-full md:w-1/2 flex items-center justify-center">
            <Components.AuthLayoutWrapper variant="login">
                <form onSubmit={handleLogin} className="flex flex-col justify-between gap-6 text-[16px] h-[390px]">
                    ...
                    <button type="submit" className="cursor-pointer bg-gradient-to-r from-[#C53771] to-[#F282B0] font-medium text-white rounded-md py-2 hover:from-[#a82d5c] hover:to-[#d65888] transition-colors h-[60px] text-[18px]">
                        Sign In
                    </button>
                </form>
